...
export default function EncargadoEventos() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Capacitaciones, juntas y actividades</p>
      </div>
      {eventos.length === 0 ? (
        <SectionCard><EmptyState title="Sin eventos" message="No hay eventos programados." icon={CalendarDays} /></SectionCard>
      ) : (
